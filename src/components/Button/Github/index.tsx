...
const hoverClass = 'hover:bg-[#24292F]/90'
const focusClass = 'focus:ring-4 focus:outline-none focus:ring-[#24292F]/50'
const darkModeClass = 'dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30'
